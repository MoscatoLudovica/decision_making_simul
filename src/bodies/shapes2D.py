...
class Shape:
    ...
    def __init__(self, center: Vector2D):
        self.center = center
...
class Circle(Shape):
    def __init__(self, radius:float, center: Vector2D):
...
class Square(Shape):
    ...
    def __init__(self, side_length:float, center: Vector2D):
        super().__init__(center)
        self.side_length = side_length
        self.set_vertices()
    
    def configure(self, side_length:float, new_center: Vector2D):
...
class Triangle(Shape):
    def __init__(self, hypotenuse:float, angle1:float, angle2:float, center: Vector2D):
        ...
        self.height = hypotenuse * math.sin(self.angle2)
    ...
    def set_vertices(self):
        ...
        self._vertices = [
            Vector2D(self.center.x - self.base * 0.5, self.center.y - self.height * 0.5),
            Vector2D(self.center.x + self.base * 0.5, self.center.y - self.height * 0.5),
            Vector2D(self.center.x, self.center.y + self.height * 0.5)
        ]
